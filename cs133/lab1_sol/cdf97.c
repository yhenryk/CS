...
/*
			if (i == 0)
			{
			FILE * debug = fopen("debug_ori.txt", "w");
			int ii, jj;
			for (ii = 0; ii < N; ii++){
				for (jj = 0; jj < M; jj++)
					fprintf(debug, "%f\t", tempbank[ii * M + jj]);
				fprintf(debug, "\n");
			}
			fclose(debug);
		    }*/
...
/*
			if (i == 0)
			{
			FILE * debug = fopen("debug_pd.txt", "w");
			int ii, jj;
			for (ii = 0; ii < N; ii++){
				for (jj = 0; jj < M; jj++)
					fprintf(debug, "%f\t", tempbank[ii * M + jj]);
...
*/
			...
			if (i == 0)
			{
			FILE * debug = fopen("debug_interleaved.txt", "w");
			int ii, jj;
			for (ii = 0; ii < N; ii++){
				for (jj = 0; jj < M; jj++)
					fprintf(debug, "%f\t", x[ii * M + jj]);
				fprintf(debug, "\n");
			}
			fclose(debug);
			}
